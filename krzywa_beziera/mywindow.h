...
private:
    ...
    // Grupa przyciskow
    QGroupBox *grupa;
    // Pole przechowujace obravector<punkty> v;zek
    QImage *img;
    QImage *mvImg;
    ...
    void rysuj1();
    void rysuj2();
    void rysujpiksel(int j, int x, QImage *obrazek, int r = 255, int g = 255, int b = 255);
    void rysujokrag();
    void rysujelipse();
    void rysujwielokat();
    void obliczenia2(int x1, int y1, int x2, int y2);
    void krzywa_beziera(int zmiana = 0);
    void rysuj_punkt(int x, int y, int r = 255, int g = 255, int b = 255);
    int czytrafiony(int x, int y);
